...
\begin{document}
	%<*content>
	\development{algebra}{theoreme-kronecker}{Théorème de Kronecker}
	...
	\begin{demonstration}
		Si $0$ est racine de $P$, alors $X \mid P$, donc $P = X$ par irréductibilité et unitarité. Sinon, $0$ n'est pas racine de $P$. On peut donc appliquer le \cref{theoreme-kronecker-2} à $P$ ; et donc les racines de $P$ sont des racines de l'unité. Ainsi, en notant $N$ le maximum des ordres des racines de $P$, on a :
