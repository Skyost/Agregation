...
\begin{document}
	%<*content>
	\development{analysis}{theoreme-weierstrass-convolution}{Théorème de Weierstrass (par la convolution)}
	...
	\begin{lemma}
		\label{weierstrass-convolution-1}
	...
	\begin{demonstration}
		...
		De plus, $f$ est bornée et atteint ses bornes (donc écrire $\Vert f \Vert_\infty$ a du sens). On peut appliquer le \cref{weierstrass-convolution-1} point $(iii)$ :
		\[ \exists N \in \mathbb{N} \text{ tel que } \forall n \geq N, \, \int_{|t| \geq \eta} p_n(t) \, \mathrm{d}t < \epsilon \]
		Donc, toujours avec le \cref{weierstrass-convolution-1}, pour tout $n \geq N$ et pour tout $x \in \mathbb{R}$,
		\begin{align*}
