...
\begin{document}
	%<*content>
	\development{analysis}{lemme-morse}{Lemme de Morse}

	\summary{En usant (et en abusant) du théorème d'inversion locale, on montre le lemme de Morse et on l'applique à l'étude de la position d’une surface par rapport à son plan tangent.}
	...
	\begin{demonstration}
		...
		\newpar
		Par hypothèse, $Q(0) = \frac{\mathrm{H} (f)_0}{2}$ est une matrice symétrique inversible, donc en vertu du \cref{lemme-morse-1}, il existe un voisinage $V_1$ de $Q(0)$ dans $\mathcal{S}_n(\mathbb{R})$ et une application $\psi : V_1 \rightarrow \mathrm{GL}_n(\mathbb{R})$ de classe $\mathcal{C}^1$ tels que :
	...
	\begin{demonstration}
		...
		et le \cref{lemme-morse-2} permet d'écrire
