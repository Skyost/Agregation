...
\begin{document}
	%<*content>
	\development{analysis}{caracterisation-reelle-gamma}{Caractérisation réelle de la fonction \texorpdfstring{$\Gamma$}{Gamma}}
	...
	\begin{lemma}
		\label{caracterisation-reelle-gamma-1}
	...
	\begin{theorem}[Bohr-Mollerup]
		Soit $f : \mathbb{R}^+_* \rightarrow \mathbb{R}^+$ vérifiant les points $(i)$, $(ii)$ et $(iii)$ du \cref{caracterisation-reelle-gamma-1}. Alors $f = \Gamma$.
	\end{theorem}
	...
	\begin{demonstration}
		...
		\includelatexpicture{caracterisation-reelle-gamma}
