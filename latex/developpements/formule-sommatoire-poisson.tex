...
\begin{document}
	%<*content>
	\development{analysis}{formule-sommatoire-poisson}{Formule sommatoire de Poisson}
	...
	\begin{theorem}[Formule sommatoire de Poisson]
		\label{formule-sommatoire-poisson-1}
	...
	\begin{demonstration}
		...
		Soit $s > 0$. Appliquons le \cref{formule-sommatoire-poisson-1} à la fonction $G_{\pi s}$ :
		\begin{align*}
