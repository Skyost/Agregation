...
\begin{document}
	%<*content>
	\development{analysis}{theoreme-abel-angulaire}{Théorème d'Abel angulaire}
	...
	\begin{theorem}[Abel angulaire]
		\label{theoreme-abel-angulaire-1}
		...
		\includelatexpicture{theoreme-abel-angulaire}
	...
	\begin{demonstration}
		En appliquant le \cref{theoreme-abel-angulaire-1} :
		\begin{align*}
	...
	\begin{demonstration}
		Toujours en appliquant le \cref{theoreme-abel-angulaire-1} :
		\begin{align*}
