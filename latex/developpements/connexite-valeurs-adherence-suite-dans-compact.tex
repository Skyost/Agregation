...
\begin{document}
	%<*content>
	\development{analysis}{connexite-valeurs-adherence-suite-dans-compact}{Connexité des valeurs d'adhérence d'une suite dans un compact}
	...
	\begin{theorem}
		\label{connexite-valeurs-adherence-suite-dans-compact-1}
	...
	\begin{demonstration}
		...
		\includelatexpicture{connexite-valeurs-adherence-suite-dans-compact}
