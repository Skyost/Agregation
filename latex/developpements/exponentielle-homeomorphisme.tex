...
\begin{document}
	%<*content>
	\development{algebra}{exponentielle-homeomorphisme}{\texorpdfstring{$\exp : \mathcal{S}_n(\mathbb{R}) \rightarrow \mathcal{S}^{++}_n(\mathbb{R})$}{exp : Sn(R) -> Sn(R)++} est un homéomorphisme}
	...
	\begin{lemma}
		\label{exponentielle-homeomorphisme-1}
	...
	\begin{lemma}
		\label{exponentielle-homeomorphisme-2}
	...
	\begin{lemma}
		\label{exponentielle-homeomorphisme-3}
	...
	\begin{demonstration}
		...
		\begin{itemize}
			...
			\item \underline{L'application inverse est continue :} Soit $(A_k) \in (\mathcal{S}^{++}_n(\mathbb{R}))^\mathbb{N}$ qui converge vers $A \in \mathcal{S}^{++}_n(\mathbb{R})$. Il s'agit de montrer que la suite $(B_k)$ de terme général $B_k = \exp^{-1}(A_k)$ converge vers $B = \exp^{-1}(A)$. Supposons tout d'abord $(B_k)$ non bornée. Comme sur $\mathcal{S}_n(\mathbb{R})$, $\VERT . \VERT_2 = \rho(.)$ (par le \cref{exponentielle-homeomorphisme-3}), il existe $\varphi : \mathbb{N} \rightarrow \mathbb{N}$ strictement croissante telle que $\rho(B_\varphi(k)) \longrightarrow +\infty$. On peut donc extraire une suite de valeurs propres $(\lambda_k)$ telle que $|\lambda_k| \longrightarrow +\infty$. Encore une fois, quitte à extraire, on peut supposer $\lambda_k \longrightarrow +\infty$ ou $\lambda_k \longrightarrow -\infty$.
			\begin{itemize}
			...
			\end{itemize}
			Donc la suite $(B_k)$ est bornée. Par le théorème de Bolzano-Weierstrass, $(B_k)$ admet une valeur d'adhérence $\widetilde{B}$. Comme $\mathcal{S}_n(\mathbb{R})$ est fermé (c'est le \cref{exponentielle-homeomorphisme-1}), $\widetilde{B} \in \mathcal{S}_n(\mathbb{R})$.
			\newpar
			...
			ie. $\exp(B) = \exp(\widetilde{B})$ ; donc $B = \widetilde{B}$ par injectivité de $\exp$. Donc par le \cref{exponentielle-homeomorphisme-2}, $B_k \longrightarrow B$.
		\end{itemize}
	\end{demonstration}
	%</content>
\end{document}
