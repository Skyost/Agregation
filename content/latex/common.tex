...
function findBibFiles(folder)
	...
	local folderPath = currentDir .. package.config:sub(1,1) .. folder
    local isDirectory, errMsg = lfs.attributes(folderPath, "mode")
	if not isDirectory or errMsg ~= "directory" then
		return files
	end
