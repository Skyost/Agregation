...
\begin{document}
  ...
  \begin{proof}
    Soit $(y_n)$ une suite d'éléments de $f(E)$. Pour tout $n \in \mathbb{N}$, il existe $x_n \in E$ tel que $y_n = f(x_n)$. $E$ est compact, donc il existe une extractrice $\varphi : \mathbb{N} \rightarrow \mathbb{N}$ telle que $x_{\varphi(n)} \longrightarrow_{n \rightarrow +\infty} x$ où $x \in E$. Par continuité,
  ...
  \begin{proposition}
    ...
    Soit $E$ un espace vectoriel de dimension finie $n \geq 1$ muni d'une norme infinie $\Vert . \Vert_\infty$. Les compacts de cet espace vectoriel normé sont les parties fermées et bornées.
  \end{proposition}
  ...
  \begin{corollary}
    ...
    \begin{enumerate}[label={\bfseries(\roman*)}]
      \item \label{autour-de-la-compacite-5-1} Les parties compactes d'un espace vectoriel normé de dimension finie sont les parties fermées et bornées.
