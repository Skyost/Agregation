...
\AtBeginDocument{
	...
	{%
		\vspace*{\fill}%
		\begin{center}%
			Intégralement écrit par Hugo Delaunay dans le cadre de sa préparation à l'agrégation de mathématiques.
			\newpar
			\textit{Une coquille ? Une correction ?}
			Contactez-moi ou corrigez-la.
		\end{center}%
		\vfill%
	}%
	\newpage%
