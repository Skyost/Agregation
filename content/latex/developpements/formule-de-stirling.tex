...
\begin{document}
	...
	\begin{proof}
		...
		\begin{align*}
			...
			& \overset{t=ux}{=} \frac{\gamma^{a+b} e^{-\gamma x}}{\Gamma(a) \Gamma(b)} x^{a+b-1} \int_0^1 u^{a-1} (1-u)^{b-1} \, \mathrm{d}u \\
	...
	\begin{proof}
		...
		\begin{itemize}
			...
			\item \uline{On suppose le résultat vrai à un rang $n \geq 0$.} Pour montrer qu'il reste vrai au rang $n+1$, il suffit d'appliquer le \cref{formule-de-stirling-2} à $S_n \sim \Gamma(n+1, 1)$ et $X_{n+1} \sim \Gamma(1, 1)$ (qui sont bien indépendantes).
		\end{itemize}
