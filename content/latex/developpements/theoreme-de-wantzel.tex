...
\begin{document}
  ...
  \begin{proof}
    ...
    \begin{itemize}
      \item \underline{$M_i$ est l'intersection de deux droites} passant par des nombres constructibles de $K_i$. Alors, les coordonnées $(x_i, y_i)$ de $M_i$ sont solution d'un système d'équations de la forme
      \[
        \begin{cases}
          ax + by = c \\
          a'x + b'y = c'
      ...
      \item \underline{$M_i$ est l'intersection d'une droite et d'un cercle} passant par des points dont les coordonnées sont des nombres constructibles de $K_i$ et de rayon un nombre constructible de $K_i$. Alors, les coordonnées $(x_i, y_i)$ de $M_i$ sont solution d'un système d'équations de la forme
      \[
        \begin{cases}
          ax + by = c \\
          (x-a')^2 + (y-b')^2 = c'
      ...
      \begin{itemize}
        ...
        \item \underline{Si $a = 0$}, alors $y_i \in K_i$, ce qui entraîne $[K_{i+1}:K_i] = [K_i(x_i):K_i] = 2$.
      \end{itemize}
      \item \underline{$M_i$ est l'intersection de deux cercles} passant par des points dont les coordonnées sont des nombres constructibles de $K_i$ et de rayon un nombre constructible de $K_i$. Alors, les coordonnées $(x_i, y_i)$ de $M_i$ sont solution d'un système d'équations de la forme
      \[
      \begin{cases}
        (x-a)^2 + (y-b)^2 = c \\
        (x-a')^2 + (y-b')^2 = c'
    ...
    \begin{itemize}
      \item \underline{Initialisation :} $L_0 = \mathbb{Q}$ : cela résulte du \cref{theoreme-de-wantzel-1}.
      \item \underline{Hérédité :} Supposons $L_j \subseteq \mathbb{E}$ pour $j \in \llbracket 0, p-1 \rrbracket$. Soit $x \in L_{j+1}$. Comme, par hypothèse,
      \[ [L_{j+1}:L_j] = 2 \]
      la famille $(1,x,x^2)$ est $L_j$-liée :
      \[ \exists a, b, c \in L_j \setminus \{ 0 \} \text{ tels que } ax^2 + bx + c = 0 \]
      \begin{itemize}
        \item \underline{Si $a = 0$}, alors, $x = -\frac{c}{b} \in L_j$. Donc $x \in \mathbb{E}$.
