...
\begin{document}
  ...
  \begin{proof}
    ...
    \[ \pi_A = \chi_A \]
    \uline{Réciproque :} On suppose $\pi_A = \chi_A$. Par la \cref{dimension-du-commutant-1}, on peut trouver $x \in \mathbb{K}^n \setminus \{ 0 \}$ tel que $(x, Ax, \dots, A^{n-1}x)$ est une base de $\mathbb{K}^n$. Ainsi, l'application
    \[ \varphi :
    \begin{array}{ccc}
