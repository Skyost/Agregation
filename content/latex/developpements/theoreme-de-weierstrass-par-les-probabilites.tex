...
\begin{document}
  ...
  \begin{proof}
    ...
    \end{array}
    \]
    Par le \cref{theoreme-de-weierstrass-par-les-probabilites-1}, la fonction $f \circ \varphi^{-1}$ est limite uniforme d'une suite de fonctions polynomiales $(p_n)$. Donc $f$ est limite uniforme de la suite $(p_n \circ \varphi)$ où $\forall n \in \mathbb{N}$, $p_n \circ \varphi$ est bien une fonction polynomiale car $\varphi$ est affine.
  \end{proof}
  %</content>
\end{document}
