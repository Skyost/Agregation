...
\begin{document}
  ...
  \begin{proof}
    ...
    \[ \mathbb{P}(e^{it \mathbb{1}_{A_{n,k}}} = e^{it}) = \mathbb{P}(\mathbb{1}_{A_{n,k}} = 1) = p_{n,k} \text{ et } \mathbb{P}(e^{it \mathbb{1}_{A_{n,k}}} = 1) = \mathbb{P}(\mathbb{1}_{A_{n,k}} = 0) = 1 - p_{n,k} \]
