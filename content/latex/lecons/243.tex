...
\begin{document}
  ...
  \begin{proposition}[Règle de d'Alembert]
    Soit $\sum a_n z^n$ une série entière telle que $a_n \neq 0$ à partir d'un certain rang. Si $\lim_{n \rightarrow +\infty} \left| \frac{a_{n+1}}{a_n} \right| = \lambda$ avec $\lambda \in [0, +\infty]$, alors le rayon de convergence de $\sum a_n z^n$ est égal à $\frac{1}{\lambda}$.
  \end{proposition}
  ...
  \begin{example}
    ...
    \begin{itemize}
      ...
      \item $\sum \frac{1}{n} z^n$ dont le rayon de convergence est égal à $1$ diverge en $1$ mais converge en tout autre point de $C(0,1)$.
    \end{itemize}
  \end{example}
  ...
  \begin{proposition}
    En multipliant $\sum a_n z^n$ par un scalaire non nul, on ne change pas le rayon de convergence de la série initiale.
  \end{proposition}
  ...
  \begin{theorem}[Zéros isolés]
    Soient $U \subseteq \mathbb{C}$ un ouvert connexe et $f : U \rightarrow \mathbb{C}$. Si $f$ est une fonction analytique non identiquement nulle, alors l'ensemble des zéros de $f$ n'admet pas de point d'accumulation dans $U$.
  \end{theorem}

  \begin{corollary}
    Soient $U \subseteq \mathbb{C}$ un ouvert connexe et $f : U \rightarrow \mathbb{C}$ une fonction analytique non identiquement nulle. Alors $f$ admet un nombre fini de zéros dans tout compact de $U$.
  \end{corollary}
