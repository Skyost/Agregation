...
\begin{document}
  ...
  \begin{proposition}
    ...
    \begin{enumerate}[label={\bfseries(\roman*)}]
      ...
      \item Pour tout $a \in \mathbb{R}^d$, et $\xi \in \mathbb{R}^d$,
      \[ \mathcal{F}(x \mapsto f(x-a))(\xi) = e^{-i\langle a,\xi\rangle} \widehat{f}(\xi) \text{ et } \mathcal{F}(x \mapsto e^{i\langle a,x\rangle}f(x))(\xi)=\widehat{f}(\xi-a) \]
    \end{enumerate}
  \end{proposition}
  ...
  \begin{proposition}
    Soit $f \in L_1(\mathbb{R}^d)$ et soit $j \in \llbracket 1, d \rrbracket$.
    \begin{enumerate}[label={\bfseries(\roman*)}]
      ...
      \item On suppose $(\xi_1, \dots, \xi_d) \mapsto y_j f(\xi_1, \dots, \xi_d) \in L_1(\mathbb{R}^d)$. Alors, la $j$-ième dérivée partielle de $\widehat{f}$ existe, et
      \[ \forall \xi = (\xi_1, \dots, \xi_d) \in \mathbb{R}^d, \, \frac{\partial \widehat{f}}{\partial \xi_j}(\xi) = -i \widehat{\xi_j f}(\xi) \]
    \end{enumerate}
  \end{proposition}
  ...
  \begin{application}
    ...
    \[ \forall \xi \in \mathbb{R}, \, \widehat{f}'(\xi) = -\frac{\xi}{2\alpha}\widehat{f}(\xi) \]
  ...
  \begin{example}
    ...
    \[ \int_{\mathbb{R}} \frac{y(t)}{(x-t)^2 + a^2} \, \mathrm{d}t = \frac{1}{x^2 + b^2} \]
  ...
  \begin{proposition}
    ...
    \[ \lim_{A \rightarrow +\infty} \Vert \varphi_A - \widehat{f} \Vert_2 = 0 \text{ et } \lim_{A \rightarrow +\infty} \Vert \psi_A - f \Vert_2 = 0 \]
    où
    \[ \varphi_A(\xi) = \int_{-A}^{A} f(x) e^{-ix\xi} \, \mathrm{d}x \text{ et } \psi_A(x) = \frac{1}{2 \pi} \int_{-A}^{A} \widehat{f}(\xi) e^{ix\xi} \, \mathrm{d}\xi \]
  \end{proposition}
  ...
  \begin{example}
    ...
    \[ \text{pp. en } x \in \mathbb{R}, \, \widehat{\widehat{f}}(x) = 2\pi f(-x) = 2\pi\mathbb{1}_{[-a,a]}(x) \]
  \end{example}
  ...
  \begin{definition}
    On appelle \textbf{classe de Schwartz}, notée $\mathcal{S}(\mathbb{R}^d)$, l'espace des fonctions $f : \mathbb{R}^d \rightarrow \mathbb{C}$ telles que :
    \begin{itemize}
  ...
  \begin{remark}
    ...
    \[ \forall t \in \mathbb{R}^d, \, \phi_X(t) = \int_{\mathbb{R}^d} e^{i \langle t, x \rangle} f(x) \, \mathrm{d}x \]
  \end{remark}
  ...
  \begin{example}
    \begin{itemize}
      \item $X \sim \mathcal{U}([-1, 1]) \iff \forall t \in \mathbb{R}, \, \phi_X(t) = \begin{cases}
        ...
        1 \text{ sinon}
      \end{cases}$
      \item $X \sim \mathcal{E}(\lambda) \iff \forall t \in \mathbb{R}, \, \phi_X(t) = \frac{\lambda}{\lambda-it}$.
