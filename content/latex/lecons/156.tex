...
\begin{document}
  ...
  \begin{remark}
    ...
    \begin{itemize}
      \item $0$ est valeur propre de $u$ si et seulement si $\ker(u) \neq \{ 0 \}$.
  ...
  \begin{remark}
    On dispose de caractérisations analogues au \cref{156-1} pour les endomorphismes unipotents. Par exemple, un endomorphisme $u$ de $E$ est unipotent si et seulement si $\chi_u = (X-1)^n$.
  \end{remark}
