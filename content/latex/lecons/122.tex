...
\begin{document}
  ...
  \begin{theorem}
    ...
    \begin{enumerate}[label=(\roman*)]
      \item Si $a$ est non nul et non inversible, $(a)$ est premier si et seulement si $a$ est irréductible.
  ...
  \begin{corollary}
    Soient $\mathbb{K}$ un corps commutatif et $f \in \mathbb{K}[X]$. Alors $\mathbb{K}[X]/(f)$ est un corps si et seulement si $f$ est irréductible dans $\mathbb{K}[X]$.
  \end{corollary}
  ...
  \begin{application}[Polynômes d'interpolation de Lagrange]
    Soit $\mathbb{K}$ un corps commutatif, $\alpha_1, \dots, \alpha_n$ des éléments distincts de $\mathbb{K}$ et $\beta_1, \dots, \beta_n$ des éléments de $\mathbb{K}$. Alors, il existe un unique polynôme $g \in \mathbb{K}[X]$ de degré inférieur ou égal à $n-1$ tel que $g(\alpha_i) = \beta_i$ pour tout $i \in \llbracket 1, n \rrbracket$.
  \end{application}
