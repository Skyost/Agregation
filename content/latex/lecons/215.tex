...
\begin{document}
  ...
  \begin{application}
    Soit $\varphi : U \to \mathbb{R}^n$ un $\mathcal{C}^1$-difféomorphisme. On pose $V = \varphi(U)$. Alors $V$ est un ouvert de $\mathbb{R}^n$. De plus, pour toute fonction mesurable $f : V \to \mathbb{R}$, on a
    \[
      f \in L^1(V)
      \iff
      \left(y \mapsto
