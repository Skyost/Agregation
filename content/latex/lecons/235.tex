...
\begin{document}
  ...
  \begin{example}
    La fonction $x \mapsto \sum_{n=1}^{+\infty} \frac{e^{-n\vert x \vert}}{n^2}$ est continue sur $\mathbb{R}$.
  \end{example}
  ...
  \begin{example}
    ...
    \[ \forall k \in \mathbb{N}, \, \forall s \in ]1, +\infty[, \zeta^{(k)}(s) = (-1)^k \sum_{n=1}^{+\infty} \frac{(\ln(n))^k}{n^s} \]
  \end{example}
  ...
  \begin{proposition}
    Soit $\sum a_n z^n$ une série entière de rayon de convergence $r \neq 0$. On note $f$ la somme de cette série sur $D(0,r)$. Alors $f \in \mathcal{H}(D(0, r))$ et,
    \[ f'(z) = \sum_{n=1}^{+\infty} n a_n z^{n-1} \]
    pour tout $z \in D(0, r)$.
    \newpar
    Plus précisément, pour tout $k \in \mathbb{N}$, $f$ est $k$ fois dérivable avec
    \[ f^{(k)}(z) = \sum_{n=k}^{+\infty} n (n-1) \dots (n-k+1) a_n z^{n-k} \]
  \end{proposition}
  ...
  \begin{cexample}
    ...
    \[ \lim_{\substack{z \rightarrow 1 \\ \vert z \vert < 1}} \sum_{n=0}^{+\infty} (-1)^n z^n = \lim_{\substack{z \rightarrow 1 \\ \vert z \vert < 1}} \frac{1}{1+z} = \frac{1}{2} \]
    alors que la série $\sum_{n=0}^{+\infty} (-1)^n$ diverge.
  \end{cexample}
  ...
  \begin{remark}
    \begin{itemize}
      \item Si dans le \cref{235-4}, hypothèse (ii), on remplace ``dérivable'' par ``$\mathcal{C}^1$'', alors la fonction $F$ est de classe $\mathcal{C}^1$.
  ...
  \begin{theorem}[Théorème de Fubini-Tonelli]
  ...
  \begin{theorem}[Théorème de Fubini-Lebesgue]
  ...
  \begin{example}
    ...
    \[ \iint_D = f(x,y) \, \mathrm{d}x \mathrm{d}y = \int_0^1 x \frac{(1-x)^2}{2} \, \mathrm{d}x = \frac{1}{24} \]
  \end{example}
  ...
  \begin{definition}
    ...
    \[ \forall n \in \mathbb{Z}, \, c_n(f) = \frac{1}{2\pi} \int_{0}^{2\pi} f(t) e^{-int} \, \mathrm{d}t \]
    La \textbf{série de Fourier} associée à $f$ est
    \[ \sum_{n \in \mathbb{Z}} c_n(f)e^{inx} \]
  \end{definition}

  \begin{theorem}[Égalité de Parseval]
    Soit $f : \mathbb{R} \rightarrow \mathbb{C}$ une application $2\pi$-périodique et continue par morceaux sur $\mathbb{R}$. Alors,
    \[ \sum_{n=-\infty}^{+\infty} |c_n(f)|^2 = \frac{1}{2\pi} \int_0^{2\pi} |f(t)|^2 \, \mathrm{d}t \]
  \end{theorem}
  ...
  \begin{theorem}[Théorème de Jordan-Dirichlet]
