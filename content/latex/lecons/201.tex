...
\begin{document}
  ...
  \begin{cexample}
    Cela ne marche pas si $f$ n'est pas continue. Par exemple, la fonction $f : [0,1] \rightarrow \mathbb{R}$ définie par $f(0)=0$ et $f(x)=\frac{1}{x}$ si $x>0$ vérifie $f([0,1]) = \{0\} \, \cup \, [1,+\infty[$, qui n'est pas compact.
  \end{cexample}
  ...
  \begin{corollary}
    Une limite uniforme sur $\mathbb{R}$ de fonctions polynomiales est une fonction polynomiale.
  \end{corollary}
  ...
  \begin{theorem}
    ...
    \begin{enumerate}[label={\bfseries(\roman*)}]
      \item La famille orthonormée $(e_n)_{n \in I}$ est une base hilbertienne de $L_2$.
      \item $\forall f \in L_2, \, f = \sum_{n=0}^{+\infty} \langle f, e_n \rangle e_n$.
      \item $\forall f \in L_2, \, \Vert f \Vert_2^2 = \sum_{n=0}^{+\infty} \vert \langle f, e_n \rangle \vert^2$.
    \end{enumerate}
  \end{theorem}
