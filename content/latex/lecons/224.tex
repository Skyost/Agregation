...
\begin{document}
  ...
  \begin{remark}
    Dans la pratique, on utilisera souvent cette notation pour des fonctions de $\mathbb{R}$ dans $\mathbb{C}$ au voisinage d'un point de $\mathbb{R}$ ou de l'infini, ou pour des suites réelles ou complexes $(u_n)$ quand $n \rightarrow +\infty$.
  \end{remark}
  ...
  \begin{proposition}
    \begin{enumerate}[label=(\roman*)]
      ...
      \item Si $f$ est dérivable sur $I$ et si $f'$ admet un développement limité en $0$ : $f'(x) = \sum_{k=0}^{n} a_k x^k + o(x^n)$ ; alors, $f$ admet un développement limité en $0$ donné par $f(x) = f(0) + \sum_{k=0}^{n} \frac{a_k}{k+1} x^{k+1} + o(x^{n+1})$.
