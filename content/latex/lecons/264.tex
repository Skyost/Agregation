...
\begin{document}
	...
	\begin{definition}
		La variable aléatoire $X$ est dite \textbf{discrète} si $X(\Omega)$ est fini ou est dénombrable.
	\end{definition}
	...
	\begin{theorem}[Loi forte des grands nombres]
		...
		\[ X_1 \in \mathcal{L}_1 \iff M_n \overset{(p.s.)}{\longrightarrow} \ell \in \mathbb{R} \]
