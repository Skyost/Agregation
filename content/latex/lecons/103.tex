...
\begin{document}
  ...
  \begin{definition}
    ...
    \begin{itemize}
      ...
      \item On appelle \textbf{indice} de $H$ dans $G$, et on note $(G:H)$, le cardinal de $G/H$.
    \end{itemize}
  \end{definition}
  ...
  \begin{proposition}
    $u \in \mathrm{GL}(E)$ est une transvection de droite $D$ si et seulement si $u \neq \operatorname{id}_E$, $u_{|D} = \operatorname{id}_D$ et le morphisme induit $\overline{u} : E/D \rightarrow E/D$ est l'identité.
  \end{proposition}
