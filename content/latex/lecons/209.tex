...
\begin{document}
  ...
  \begin{theorem}
    ...
    \begin{itemize}
      ...
      \item Si $f$ est continue en tout point d'un compact $K$, alors $\sup_{x \in K} |(f * \rho_n)(x) - f(x)| \longrightarrow_{n \rightarrow +\infty} 0$.
    \end{itemize}
  \end{theorem}
  ...
  \begin{proposition}
    Soit $N \in \mathbb{N}$.
    \begin{enumerate}[label=(\roman*)]
      \item $D_N$ est une fonction paire, $2\pi$-périodique, et vérifie $c_0(D_N) = 1$.
