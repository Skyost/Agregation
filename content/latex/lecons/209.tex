...
\begin{document}
	...
	\begin{theorem}
		...
		\begin{enumerate}[label=(\roman*)]
			...
			\item \label{209-2} $\forall x \in H, \, \Vert x \Vert_2 = \sum_{n=0}^{+\infty} \vert \langle x, \epsilon_n \rangle \vert^2$.
		\end{enumerate}
	\end{theorem}

	\begin{remark}
		L'égalité du \cref{274-1} \cref{209-2} est appelée \textbf{égalité de Parseval}.
	\end{remark}
