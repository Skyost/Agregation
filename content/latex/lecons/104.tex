...
\begin{document}
  ...
  \begin{theorem}
    ...
    \begin{enumerate}[label={\bfseries(\roman*)}]
      ...
      \item \label{104-2} $g$ est d'ordre fini si et seulement s'il existe $n \in \mathbb{N}^*$ tel que $e_G, g, \dots, g^{n-1}$ sont tous distincts et $g^n = e_G$. Dans ce cas, $g$ est d'ordre $n$.
    \end{enumerate}
  \end{theorem}
  ...
  \begin{theorem}[Théorème de Kronecker]
  ...
  \begin{theorem}[Théorème de Cayley]
