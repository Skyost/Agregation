...
\begin{document}
  ...
  \begin{theorem}[Théorème d'Hermite]
    $e$ est transcendant.
  \end{theorem}

  \begin{theorem}[Théorème de Lindemann]
    $\pi$ est transcendant.
  \end{theorem}
  ...
  \begin{proposition}
    ...
    \begin{enumerate}[label={\bfseries(\roman*)}]
      \item $\sqrt{d} \notin \mathbb{Q}$.
      \item $\sqrt{d} \notin \mathbb{N}$.
      \item Il existe $p$ premier tel que $v_p(d)$ (la valuation $p$-adique de $d$) est impaire.
  ...
  \begin{proposition}
    ...
    \begin{enumerate}[label={\bfseries(\roman*)}]
      ...
      \item $\mathbb{Q}[\sqrt{d}] \equiv \mathbb{Q}[X]/(X^2 - d)$ est un corps.
  ...
  \begin{proposition}
    ...
    \begin{enumerate}[label={\bfseries(\roman*)}]
      \item Les inversibles de $\mathbb{Z}[\sqrt{d}]$ sont exactement les éléments $z$ tels que $N(z) = \pm 1$.
      \item Tout élément non nul et non inversible de $\mathbb{Z}[\sqrt{d}]$ possède une décomposition en produit d'irréductibles.
    \end{enumerate}
  \end{proposition}
