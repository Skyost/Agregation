...
\begin{document}
  ...
  \begin{theorem}[Caractérisations séquentielle et topologique de la continuité]
    \begin{enumerate}[label={\bfseries(\roman*)}]
      ...
      \item $f$ est continue sur $I$ si et seulement si l'image réciproque par $f$ de tout ouvert (resp. fermé) de $\mathbb{R}$ est un ouvert (resp. fermé) de $I$.
    \end{enumerate}
  \end{theorem}

  \begin{example}
    La fonction $x \mapsto \cos \left( \frac{1}{x} \right)$ définie sur $\mathbb{R}_*$ n'admet pas de prolongement continu en $0$.
  \end{example}
  ...
  \begin{remark}
    \begin{itemize}
      ...
      \item Pour $a \in \mathring I$, $f$ est dérivable en $a$ si et seulement si $f$ est dérivable à gauche et à droite en $a$, avec $f'_g(a) = f'_d(a)$.
  ...
  \begin{proposition}
    Soit $J$ un intervalle de $\mathbb{R}$. Si $g : I \rightarrow J$ est dérivable en $a$ et si $f : J \rightarrow \mathbb{R}$ est dérivable en $g(a)$, alors $f \circ g$ est dérivable en $a$ et
    \[ (f \circ g)'(a) = g'(a) f'(g(a)) \]
  \end{proposition}

  \begin{corollary}
    Soient $J$ un intervalle de $\mathbb{R}$ et $h : I \rightarrow J$ une bijection continue sur $I$ et dérivable en $a \in I$. Alors, $h^{-1}$ est dérivable en $b = h(a)$ si et seulement si $h'(a) \neq 0$, et on a
  ...
  \begin{theorem}[Théorème de la bijection monotone]
  ...
  \begin{theorem}[Théorème de Lebesgue]
  ...
  \begin{corollary}
    On suppose $f$ continue sur $[a,b]$ et dérivable sur $]a,b[$. Alors, $f$ est croissante si et seulement si $f'(x) \geq 0$ pour tout $x \in ]a,b[$. De plus, $f$ est constante si et seulement si $f'$ est identiquement nulle sur $]a,b[$.
  \end{corollary}
  ...
  \begin{theorem}[Théorème de Darboux]
  ...
  \begin{theorem}[Théorème de Weierstrass]
    Toute fonction continue sur un compact est limite uniforme de fonctions polynomiales.
  \end{theorem}
