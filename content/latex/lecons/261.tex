...
\begin{document}
  ...
  \begin{example}
    ...
    \begin{itemize}
      \item \label{261-2} Si $x \in \mathbb{R}$, on pose $\delta_x : A \mapsto \mathbb{1}_A(x)$. C'est une loi discrète sur $\mathcal{B}(\mathbb{R})$.
  ...
  \begin{example}
    ...
    \begin{itemize}
      ...
      où $\lambda(K)$ désigne la mesure de l'ensemble $K$.
  ...
  \begin{corollary}
    ...
    et dans ce cas,
    \[ \mathbb{E}(g(X)) = \int_{\mathbb{R}} g f \, \mathrm{d}\lambda \]
  \end{corollary}
  ...
  \begin{definition}
    ...
    \[ \forall A, B \in \mathcal{F}, \, \mathbb{P}(\{ X \in A \} \, \cap \, \{ Y \in B \}) = \mathbb{P}_X(A) \mathbb{P}_Y(B) \]
  \end{definition}
  ...
  \begin{theorem}
    \begin{enumerate}[label={\bfseries(\roman*)}]
      ...
      \item L'ensemble des points de discontinuité de $F_X$ est au plus dénombrable.
    \end{enumerate}
  \end{theorem}
  ...
  \begin{example}
    ...
    \[ \forall t \in \mathbb{R}, \, \phi_X(t) = e^{-\frac{\sigma^2 t^2}{2}} \]
  \end{example}
  ...
  \begin{theorem}
    \begin{enumerate}[label={\bfseries(\roman*)}]
      ...
      \item $\phi_X$ est uniformément continue sur $\mathbb{R}^d$.
    \end{enumerate}
  \end{theorem}

  \begin{theorem}
    Soient $X$ et $Y$ deux variables aléatoires indépendantes et intégrables. Alors,
  ...
  \begin{remark}
    En prolongeant $G_X$ au disque unité fermé de $\mathbb{C}$ par la même série, on a
