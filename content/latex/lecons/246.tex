...
\begin{document}
	...
	\begin{theorem}
		...
		\begin{enumerate}[(i)]
			...
			\item $\forall x \in H, \, x = \sum_{n=0}^{+\infty} \langle x, \epsilon \rangle \epsilon$.
			\item \label{246-4} $\forall x \in H, \, \Vert x \Vert_2 = \sum_{n=0}^{+\infty} \vert \langle x, \epsilon \rangle \vert^2$.
		\end{enumerate}
	\end{theorem}
