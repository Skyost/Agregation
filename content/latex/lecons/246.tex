...
\begin{document}
  ...
  \begin{example}
    On définit, pour tout $\alpha \in \mathbb{R} \setminus \mathbb{Z}$, $f_\alpha$ comme le prolongement $2\pi$-périodique de $t\mapsto\cos(\alpha t)$ sur $[-\pi,\pi[$. Alors,
  ...
  \begin{theorem}
    ...
    \begin{enumerate}[label={\bfseries(\roman*)}]
      ...
      \item \label{246-3} $\forall x \in H, \, \Vert x \Vert^2 = \sum_{n=0}^{+\infty} \vert \langle x, \epsilon_n \rangle \vert^2$.
    \end{enumerate}
  \end{theorem}
  ...
  \begin{corollary}
    L'espace des polynômes trigonométriques $\{ \sum_{n=-N}^N c_n e_n \mid N \in \mathbb{N}, \, (c_{-N},\dots,c_N) \in \mathbb{C}^{2N+1} \}$ est dense dans l'espace des fonctions continues $2\pi$-périodiques pour $\Vert . \Vert_\infty$ et est dense dans $L_p^{2\pi}$ pour $\Vert . \Vert_p$ avec $p \in [1,+\infty[$.
  \end{corollary}
  ...
  \begin{application}[Sommes de Gauss]
    \[ \forall m \in \mathbb{N}^*, \, \sum_{n=0}^{m-1} e^{\frac{2i\pi n^2}{m}} = \sqrt{m} \frac{1+i^{-m}}{1+i^{-1}} \]
  \end{application}
  ...
  \begin{figure}[H]
    \begin{center}
      \begin{whitetabularx}{|X|X|}
        ...
        \hline
        $f \in L_p^{2\pi}$ ($p \in [1,+\infty[$) & Convergence pour $\Vert . \Vert_p$ au sens de Cesàro. \\
        \hline
