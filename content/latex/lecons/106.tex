...
\begin{document}
  ...
  \begin{proposition}
    ...
    \[ u \in \mathcal{O}(E) \iff \forall x \in E, \, \Vert u(x) \Vert = \Vert x \Vert \iff u \in \mathrm{GL}(E) \text{ et } u^{-1} = u^* \]
  \end{proposition}
  ...
  \begin{proposition}
    ...
    \begin{enumerate}[label={\bfseries(\roman*)}]
      ...
      \item $|\mathrm{PSL}(E)| = \frac{|\mathrm{SL}(E)|}{\operatorname{pgcd}(n,q-1)} = \frac{|\mathrm{GL}(E)|}{(q-1)\operatorname{pgcd}(n,q-1)}$.
    \end{enumerate}
  \end{proposition}
  ...
  \begin{theorem}
    \begin{enumerate}[label={\bfseries(\roman*)}]
      ...
      pour $r \in \llbracket 0, n \rrbracket$.
      ...
      \[ \mathcal{O}_{(s,t)} = \{ A \in \mathcal{S}_n(\mathbb{R}) \mid \operatorname{sign}(\Phi_A) = (s,t) \} \]
      où $\Phi_A$ désigne la forme quadratique associée à une matrice $A \in \mathcal{S}_n(\mathbb{R})$.
      \item \uline{Si $\mathbb{K} = \mathbb{F}_q$ avec $q$ impair :} deux matrices symétriques $A$ et $B$ sont congruentes si et seulement si elles ont même rang et si leurs restrictions à des supplémentaires de leurs noyaux ont même discriminant modulo les carrés de $\mathbb{F}_q^*$.
    \end{enumerate}
  \end{theorem}
