...
\begin{document}
	%<*content>
	\lesson{analysis}{245}{Fonctions holomorphes et méromorphes sur un ouvert de \texorpdfstring{$\mathbb{C}$}{C}. Exemples et applcations.}
	...
	\begin{theorem}[Conditions de Cauchy-Riemann]
		...
		\begin{enumerate}[(i)]
			...
			\item $\operatorname{d}f_a$ est $\mathbb{C}$-linéaire.
	...
	\begin{application}[Théorème de Kroenecker]
